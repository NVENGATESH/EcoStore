      ...
      <header className="header">
        <div className="navHeaderContainer">
          ...
          <nav className="mainNav">
            ...
            <Link to="/eco-store" className='navlinks'>UserInfo</Link>
          ...
          <div className="userContainer">
            ...
            >
              ...
              <p className="useremail">email@example.com</p>
              <button className="logoutBtn" onClick={() => { /* handle logout */ }}>
                Logout
              </button>
            </div>
          </div>
